"""Replay candidate 16 through the flattened family-transition registry."""
...
from populace_dynamics.models.family_transitions.compatibility import (
...
DEFAULT_OUTPUT = ROOT / "runs" / "registry_compatibility_certificate_v1.json"
...
def main() -> None:
    ...
    evaluation = evaluate_candidate16(ROOT, verbose=not args.quiet)
